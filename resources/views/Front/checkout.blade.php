                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
                        <div class="ps-checkout__billing">
                            ...
                            <div class="form-group form-group--inline">
                                <x-form-input name="billing_phone" type="phone" :label="__('Phone')" />
                            </div>
                            <div class="form-group form-group--inline">
                            ...
                            <div class="form-group">
                                <div class="ps-checkbox">
                                    <input class="form-control" type="checkbox" name="create_account" id="cb01">
                            ...
                            <div class="form-group form-group--inline textarea">
                                ...
                                <textarea class="form-control" rows="5" name="notes" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                            </div>
                        </div>
                    </div>
